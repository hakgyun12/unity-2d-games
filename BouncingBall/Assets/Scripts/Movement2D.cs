...
public class Movement2D : MonoBehaviour
{
    ...
    private Collider2D collider2D_1; // 광선 발사 위치 설정을 위한 충돌 범위
    private ColliderCorner colliderCorner; // 광선 발사를 위한 모서리 짐
    ...
    {
        float direction = Mathf.Sign(velocity.y); // 이동방향 (오:1, 왼:-1)
