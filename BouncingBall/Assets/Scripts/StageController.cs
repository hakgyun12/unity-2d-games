...
{
    public static int maxStageCount; // 최대 스테이지 개수 (정적 변수. Intro 씬에서 설정)
    ...
    private void Awake()
    {
        ...
        // 인덱스가 10보다 작으면 01, 02와 같이 0을 붙여주고, 10이상이면 그대로 사용
        ...
        // 맵의 크기 정보(mapDta.mapSize)를 바탕으로 카메라 시야 크기 설정
    ...
    public void GameClear()
    {
        ...
        // 현재 스테이지 인덱스 정보를 디바이스 "StageIndex" 키로부터 불러온다
